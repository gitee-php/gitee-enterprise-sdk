...
/**
 * DocNodeLog Class Doc Comment
 *
 * @category Class
 * @description 企业文档管理日志
 * @package  GiteeEnterprise
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocNodeLog implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DocNodeLog';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['targetDoc'] = isset($data['targetDoc']) ? $data['targetDoc'] : null;
    }
     ...
     * @return string
     */
    public function getTargetDoc()
    {
        return $this->container['targetDoc'];
    }

    /**
     * Sets targetDoc
     *
     * @param string $targetDoc 操作对象
     *
     * @return $this
     */
    public function setTargetDoc($targetDoc)
    {
        $this->container['targetDoc'] = $targetDoc;
