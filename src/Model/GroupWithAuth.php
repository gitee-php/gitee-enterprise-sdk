...
/**
 * GroupWithAuth Class Doc Comment
 *
 * @category Class
 * @description 获取成员加入的团队列表
 * @package  GiteeEnterprise
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupWithAuth implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GroupWithAuth';
