...
class DocNodeLevel implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'remainingLock' => 'setRemainingLock'
    ];
    ...
    protected static $getters = [
        ...
        'remainingLock' => 'getRemainingLock'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['remainingLock'] = isset($data['remainingLock']) ? $data['remainingLock'] : null;
    }
     ...
     * Sets targetId
     *
     * @param int $targetId 快捷方式关联的node的id
     *
     * @return $this
     */
     ...
     * Sets targetFileId
     *
     * @param int $targetFileId 快捷方式关联的node的文件的id
     *
     * @return $this
     */
     ...
     * @return object
     */
    public function getRemainingLock()
    {
        return $this->container['remainingLock'];
    }

    /**
     * Sets remainingLock
     *
     * @param object $remainingLock 独占锁定信息
     *
     * @return $this
     */
    public function setRemainingLock($remainingLock)
    {
        $this->container['remainingLock'] = $remainingLock;
