...
/**
 * TreeNote Class Doc Comment
 *
 * @category Class
 * @description 获取任务类型的工作流列表
 * @package  GiteeEnterprise
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TreeNote implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TreeNote';
