...
/**
 * ProjectMemberList Class Doc Comment
 *
 * @category Class
 * @description 获取同一企业某个仓库不在本仓库组的成员列表
 * @package  GiteeEnterprise
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProjectMemberList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProjectMemberList';
     ...
     * Sets projectAccess
     *
     * @param int $projectAccess 用户在仓库中的级别
     *
     * @return $this
     */
