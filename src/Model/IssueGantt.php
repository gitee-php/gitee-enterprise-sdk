...
/**
 * IssueGantt Class Doc Comment
 *
 * @category Class
 * @description 查询指定工作项所在项目的工作项列表
 * @package  GiteeEnterprise
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IssueGantt implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IssueGantt';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['isPreIssue'] = isset($data['isPreIssue']) ? $data['isPreIssue'] : null;
    }
     ...
     * @return bool
     */
    public function getIsPreIssue()
    {
        return $this->container['isPreIssue'];
    }

    /**
     * Sets isPreIssue
     *
     * @param bool $isPreIssue 是否是当前工作项的前置工作项
     *
     * @return $this
     */
    public function setIsPreIssue($isPreIssue)
    {
        $this->container['isPreIssue'] = $isPreIssue;
