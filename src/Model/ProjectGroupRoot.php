...
/**
 * ProjectGroupRoot Class Doc Comment
 *
 * @category Class
 * @package  GiteeEnterprise
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProjectGroupRoot implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProjectGroupRoot';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['typeCn'] = isset($data['typeCn']) ? $data['typeCn'] : null;
    }
     ...
     * Sets completeName
     *
     * @param string $completeName 完整团队名称
     *
     * @return $this
     */
     ...
     * Sets completePath
     *
     * @param string $completePath 完整团队路径
     *
     * @return $this
     */
    ...
    {
        return $this->container['typeCn'];
    }

    /**
     * Sets typeCn
     *
     * @param string $typeCn 类型
     *
     * @return $this
     */
    public function setTypeCn($typeCn)
    {
        $this->container['typeCn'] = $typeCn;
