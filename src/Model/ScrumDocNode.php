...
/**
 * ScrumDocNode Class Doc Comment
 *
 * @category Class
 * @description 获取最近编辑的文档
 * @package  GiteeEnterprise
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ScrumDocNode implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScrumDocNode';
     ...
     * Sets scrumSprint
     *
     * @param \GiteeEnterprise\Model\ScrumSprint $scrumSprint 文档所属的迭代详情
     *
     * @return $this
     */
