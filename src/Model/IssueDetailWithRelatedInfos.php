...
/**
 * IssueDetailWithRelatedInfos Class Doc Comment
 *
 * @category Class
 * @description 更新任务的关联关系
 * @package  GiteeEnterprise
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IssueDetailWithRelatedInfos implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IssueDetailWithRelatedInfos';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['directionCn'] = isset($data['directionCn']) ? $data['directionCn'] : null;
    }
     ...
     * @return string
     */
    public function getDirectionCn()
    {
        return $this->container['directionCn'];
    }

    /**
     * Sets directionCn
     *
     * @param string $directionCn directionCn
     *
     * @return $this
     */
    public function setDirectionCn($directionCn)
    {
        $this->container['directionCn'] = $directionCn;
