 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PrAssign implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PrAssign';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['currentScore'] = isset($data['currentScore']) ? $data['currentScore'] : null;
    }
    ...
    {
        return $this->container['currentScore'];
    }

    /**
     * Sets currentScore
     *
     * @param int $currentScore 为pr打的分数
     *
     * @return $this
     */
    public function setCurrentScore($currentScore)
    {
        $this->container['currentScore'] = $currentScore;
