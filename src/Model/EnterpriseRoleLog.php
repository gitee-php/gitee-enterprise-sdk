...
/**
 * EnterpriseRoleLog Class Doc Comment
 *
 * @category Class
 * @description 企业角色管理日志
 * @package  GiteeEnterprise
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EnterpriseRoleLog implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EnterpriseRoleLog';
    ...
    protected static $swaggerTypes = [
        ...
        'title' => 'string',
        'operating' => 'string',
        'targetRole' => '\GiteeEnterprise\Model\EnterpriseRoleBase'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['targetRole'] = isset($data['targetRole']) ? $data['targetRole'] : null;
    }
    ...
    {
        return $this->container['targetRole'];
    }

    /**
     * Sets targetRole
     *
     * @param \GiteeEnterprise\Model\EnterpriseRoleBase $targetRole 操作对象
     *
     * @return $this
     */
    public function setTargetRole($targetRole)
    {
        $this->container['targetRole'] = $targetRole;
