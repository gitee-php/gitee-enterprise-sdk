...
class PullRequestDetail implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'reviewScore' => 'int',
        'currentReviewScore' => 'int',
        'revertedPr' => '\GiteeEnterprise\Model\RevertedPullRequest',
        'commitReviewPass' => 'bool',
        'commitReviewDetail' => 'object',
        ...
        'codeOwners' => 'string',
        'squash' => 'bool',
        'checkRunFailedCount' => 'int',
        'needPassCheckRun' => 'bool',
        'existUnresolvedComment' => 'bool',
        'requireCommentResolved' => 'bool',
    ...
    protected static $swaggerFormats = [
        ...
        'reviewStrategy' => null,
        'reviewScore' => 'int32',
        'currentReviewScore' => 'int32',
        'revertedPr' => null,
        'commitReviewPass' => null,
        'commitReviewDetail' => null,
        'milestone' => null,
        'body' => null,
        'bodyHtml' => null,
        'reactions' => null,
        ...
        'codeOwners' => null,
        'squash' => null,
        'checkRunFailedCount' => 'int32',
        'needPassCheckRun' => null,
        'existUnresolvedComment' => null,
        'requireCommentResolved' => null,
        'sourceBranchType' => null,
        'forkState' => null,
        'reopenState' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'currentReviewScore' => 'current_review_score',
        'revertedPr' => 'reverted_pr',
        'commitReviewPass' => 'commit_review_pass',
        'commitReviewDetail' => 'commit_review_detail',
        'milestone' => 'milestone',
        'body' => 'body',
        'bodyHtml' => 'body_html',
        'reactions' => 'reactions',
        ...
        'squash' => 'squash',
        'checkRunFailedCount' => 'check_run_failed_count',
        'needPassCheckRun' => 'need_pass_check_run',
        'existUnresolvedComment' => 'exist_unresolved_comment',
        'requireCommentResolved' => 'require_comment_resolved',
        'sourceBranchType' => 'source_branch_type',
        'forkState' => 'fork_state',
        'reopenState' => 'reopen_state'
    ];
    ...
    protected static $setters = [
        ...
        'currentReviewScore' => 'setCurrentReviewScore',
        'revertedPr' => 'setRevertedPr',
        'commitReviewPass' => 'setCommitReviewPass',
        'commitReviewDetail' => 'setCommitReviewDetail',
        ...
        'squash' => 'setSquash',
        'checkRunFailedCount' => 'setCheckRunFailedCount',
        'needPassCheckRun' => 'setNeedPassCheckRun',
        'existUnresolvedComment' => 'setExistUnresolvedComment',
        'requireCommentResolved' => 'setRequireCommentResolved',
        'sourceBranchType' => 'setSourceBranchType',
        'forkState' => 'setForkState',
        'reopenState' => 'setReopenState'
    ];
    ...
    protected static $getters = [
        ...
        'reviewStrategy' => 'getReviewStrategy',
        'reviewScore' => 'getReviewScore',
        'currentReviewScore' => 'getCurrentReviewScore',
        'revertedPr' => 'getRevertedPr',
        'commitReviewPass' => 'getCommitReviewPass',
        'commitReviewDetail' => 'getCommitReviewDetail',
        ...
        'squash' => 'getSquash',
        'checkRunFailedCount' => 'getCheckRunFailedCount',
        'needPassCheckRun' => 'getNeedPassCheckRun',
        'existUnresolvedComment' => 'getExistUnresolvedComment',
        'requireCommentResolved' => 'getRequireCommentResolved',
        'sourceBranchType' => 'getSourceBranchType',
        'forkState' => 'getForkState',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reviewStrategy'] = isset($data['reviewStrategy']) ? $data['reviewStrategy'] : null;
        $this->container['reviewScore'] = isset($data['reviewScore']) ? $data['reviewScore'] : null;
        $this->container['currentReviewScore'] = isset($data['currentReviewScore']) ? $data['currentReviewScore'] : null;
        $this->container['revertedPr'] = isset($data['revertedPr']) ? $data['revertedPr'] : null;
        $this->container['commitReviewPass'] = isset($data['commitReviewPass']) ? $data['commitReviewPass'] : null;
        $this->container['commitReviewDetail'] = isset($data['commitReviewDetail']) ? $data['commitReviewDetail'] : null;
        ...
        $this->container['realCount'] = isset($data['realCount']) ? $data['realCount'] : null;
        ...
        $this->container['checkRunFailedCount'] = isset($data['checkRunFailedCount']) ? $data['checkRunFailedCount'] : null;
        $this->container['needPassCheckRun'] = isset($data['needPassCheckRun']) ? $data['needPassCheckRun'] : null;
        $this->container['existUnresolvedComment'] = isset($data['existUnresolvedComment']) ? $data['existUnresolvedComment'] : null;
        $this->container['requireCommentResolved'] = isset($data['requireCommentResolved']) ? $data['requireCommentResolved'] : null;
        $this->container['sourceBranchType'] = isset($data['sourceBranchType']) ? $data['sourceBranchType'] : null;
        $this->container['forkState'] = isset($data['forkState']) ? $data['forkState'] : null;
        $this->container['reopenState'] = isset($data['reopenState']) ? $data['reopenState'] : null;
    }
     ...
     * Sets lightweight
     *
     * @param bool $lightweight 是否是轻量级PR
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getReviewStrategy()
    {
        return $this->container['reviewStrategy'];
    }

    /**
     * Sets reviewStrategy
     *
     * @param string $reviewStrategy 评审策略
     *
     * @return $this
     */
    public function setReviewStrategy($reviewStrategy)
    {
        $this->container['reviewStrategy'] = $reviewStrategy;
    ...
    {
        return $this->container['reviewScore'];
    }

    /**
     * Sets reviewScore
     *
     * @param int $reviewScore pr可以合入的最少审查得分
     *
     * @return $this
     */
    public function setReviewScore($reviewScore)
    {
        $this->container['reviewScore'] = $reviewScore;

        return $this;
    }

    /**
     * Gets currentReviewScore
     *
     * @return int
     */
    public function getCurrentReviewScore()
    {
        return $this->container['currentReviewScore'];
    }

    /**
     * Sets currentReviewScore
     *
     * @param int $currentReviewScore pr当前审查得分
     *
     * @return $this
     */
    public function setCurrentReviewScore($currentReviewScore)
    {
        $this->container['currentReviewScore'] = $currentReviewScore;
     ...
     * Gets revertedPr
     *
     * @return \GiteeEnterprise\Model\RevertedPullRequest
     */
    public function getRevertedPr()
    {
        return $this->container['revertedPr'];
    }

    /**
     * Sets revertedPr
     *
     * @param \GiteeEnterprise\Model\RevertedPullRequest $revertedPr 被回退的pr
     *
     * @return $this
     */
    public function setRevertedPr($revertedPr)
    {
        $this->container['revertedPr'] = $revertedPr;

        return $this;
    }

    /**
     * Gets commitReviewPass
     *
     * @return bool
     */
    public function getCommitReviewPass()
    {
        return $this->container['commitReviewPass'];
    }

    /**
     * Sets commitReviewPass
     *
     * @param bool $commitReviewPass pr是否通过commit review
     *
     * @return $this
     */
    public function setCommitReviewPass($commitReviewPass)
    {
        $this->container['commitReviewPass'] = $commitReviewPass;

        return $this;
    }

    /**
     * Gets commitReviewDetail
     *
     * @return object
     */
    public function getCommitReviewDetail()
    {
        return $this->container['commitReviewDetail'];
    }

    /**
     * Sets commitReviewDetail
     *
     * @param object $commitReviewDetail pr的commit review详情
     *
     * @return $this
     */
    public function setCommitReviewDetail($commitReviewDetail)
    {
        $this->container['commitReviewDetail'] = $commitReviewDetail;
    ...
    {
        return $this->container['realCount'];
    }

    /**
     * Sets realCount
     *
     * @param string $realCount diff实际差异文件数量
     *
     * @return $this
     */
    public function setRealCount($realCount)
    {
        $this->container['realCount'] = $realCount;
    ...
    /**
     * Gets checkRunFailedCount
     *
     * @return int
     */
    public function getCheckRunFailedCount()
    {
        return $this->container['checkRunFailedCount'];
    }

    /**
     * Sets checkRunFailedCount
     *
     * @param int $checkRunFailedCount 门禁失败数量
     *
     * @return $this
     */
    public function setCheckRunFailedCount($checkRunFailedCount)
    {
        $this->container['checkRunFailedCount'] = $checkRunFailedCount;

        return $this;
    }

    /**
     * Gets needPassCheckRun
     *
     * @return bool
     */
    public function getNeedPassCheckRun()
    {
        return $this->container['needPassCheckRun'];
    }

    /**
     * Sets needPassCheckRun
     *
     * @param bool $needPassCheckRun 是否需要通过全部的门禁检查
     *
     * @return $this
     */
    public function setNeedPassCheckRun($needPassCheckRun)
    {
        $this->container['needPassCheckRun'] = $needPassCheckRun;

        return $this;
    }

    /**
     * Gets existUnresolvedComment
     *
     * @return bool
     */
    public function getExistUnresolvedComment()
    {
        return $this->container['existUnresolvedComment'];
    }

    /**
     * Sets existUnresolvedComment
     *
     * @param bool $existUnresolvedComment 是否有未解决的评论
     *
     * @return $this
     */
    public function setExistUnresolvedComment($existUnresolvedComment)
    {
        $this->container['existUnresolvedComment'] = $existUnresolvedComment;

        return $this;
    }

    /**
     * Gets requireCommentResolved
     *
     * @return bool
     */
    public function getRequireCommentResolved()
    {
        return $this->container['requireCommentResolved'];
    }

    /**
     * Sets requireCommentResolved
     *
     * @param bool $requireCommentResolved 是否必须解决所有评论才可合并pr true: 是 false:否
     *
     * @return $this
     */
    public function setRequireCommentResolved($requireCommentResolved)
    {
        $this->container['requireCommentResolved'] = $requireCommentResolved;

        return $this;
    }

    /**
     * Gets sourceBranchType
     *
     * @return string
     */
    public function getSourceBranchType()
    {
        return $this->container['sourceBranchType'];
    }

    /**
     * Sets sourceBranchType
     *
     * @param string $sourceBranchType 源分支类型
     *
     * @return $this
     */
    public function setSourceBranchType($sourceBranchType)
    {
        $this->container['sourceBranchType'] = $sourceBranchType;
     ...
     * @return object
     */
    public function getForkState()
    {
        return $this->container['forkState'];
    }

    /**
     * Sets forkState
     *
     * @param object $forkState 源分支是否来自下游forked仓库
     *
     * @return $this
     */
    public function setForkState($forkState)
    {
        $this->container['forkState'] = $forkState;
     ...
     * @return object
     */
    public function getReopenState()
    {
        return $this->container['reopenState'];
    }

    /**
     * Sets reopenState
     *
     * @param object $reopenState 是否可以重新开启PR判断
     *
     * @return $this
     */
    public function setReopenState($reopenState)
    {
        $this->container['reopenState'] = $reopenState;
