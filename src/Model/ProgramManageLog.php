...
/**
 * ProgramManageLog Class Doc Comment
 *
 * @category Class
 * @description 项目管理日志
 * @package  GiteeEnterprise
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProgramManageLog implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProgramManageLog';
    ...
    protected static $swaggerTypes = [
        ...
        'updatedAt' => 'string',
        'title' => 'string',
        'targetProgram' => '\GiteeEnterprise\Model\Program',
        'operating' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['targetProgram'] = isset($data['targetProgram']) ? $data['targetProgram'] : null;
     ...
     */
    public function getTargetProgram()
    {
        return $this->container['targetProgram'];
    }

    /**
     * Sets targetProgram
     *
     * @param \GiteeEnterprise\Model\Program $targetProgram 目标项目，如果是null，表示已删除
     *
     * @return $this
     */
    public function setTargetProgram($targetProgram)
    {
        $this->container['targetProgram'] = $targetProgram;
