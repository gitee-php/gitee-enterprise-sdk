...
/**
 * GroupManageLog Class Doc Comment
 *
 * @category Class
 * @description 团队管理日志
 * @package  GiteeEnterprise
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupManageLog implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GroupManageLog';
    ...
    protected static $swaggerTypes = [
        ...
        'updatedAt' => 'string',
        'title' => 'string',
        'targetGroup' => '\GiteeEnterprise\Model\Group',
        'operating' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['targetGroup'] = isset($data['targetGroup']) ? $data['targetGroup'] : null;
     ...
     * Sets targetGroup
     *
     * @param \GiteeEnterprise\Model\Group $targetGroup 目标团队,如果是null，表示已删除
     *
     * @return $this
     */
