...
class ProjectMembersApi
{
     ...
     */
    public function postEnterpriseIdProjectsProjectIdMembers($enterpriseId, $projectId, $accessToken = null, $qt = null, $users = null, $groups = null, $accessLevel = null)
    {
        list($response) = $this->postEnterpriseIdProjectsProjectIdMembersWithHttpInfo($enterpriseId, $projectId, $accessToken, $qt, $users, $groups, $accessLevel);
        return $response;
    }
     ...
     */
    public function postEnterpriseIdProjectsProjectIdMembersWithHttpInfo($enterpriseId, $projectId, $accessToken = null, $qt = null, $users = null, $groups = null, $accessLevel = null)
    {
        $returnType = '\GiteeEnterprise\Model\ProjectMemberAdd';
        $request = $this->postEnterpriseIdProjectsProjectIdMembersRequest($enterpriseId, $projectId, $accessToken, $qt, $users, $groups, $accessLevel);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postEnterpriseIdProjectsProjectIdMembersAsync($enterpriseId, $projectId, $accessToken = null, $qt = null, $users = null, $groups = null, $accessLevel = null)
    {
        return $this->postEnterpriseIdProjectsProjectIdMembersAsyncWithHttpInfo($enterpriseId, $projectId, $accessToken, $qt, $users, $groups, $accessLevel)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postEnterpriseIdProjectsProjectIdMembersAsyncWithHttpInfo($enterpriseId, $projectId, $accessToken = null, $qt = null, $users = null, $groups = null, $accessLevel = null)
    {
        $returnType = '\GiteeEnterprise\Model\ProjectMemberAdd';
        $request = $this->postEnterpriseIdProjectsProjectIdMembersRequest($enterpriseId, $projectId, $accessToken, $qt, $users, $groups, $accessLevel);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postEnterpriseIdProjectsProjectIdMembersRequest($enterpriseId, $projectId, $accessToken = null, $qt = null, $users = null, $groups = null, $accessLevel = null)
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
