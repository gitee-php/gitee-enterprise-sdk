...
class ProjectCommitsApi
{
    ...
    /**
     * Operation getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequests
     *
     ...
     */
    public function getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequests($enterpriseId, $projectId, $commitId, $accessToken = null, $qt = null, $page = '1', $perPage = null)
    {
        list($response) = $this->getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequestsWithHttpInfo($enterpriseId, $projectId, $commitId, $accessToken, $qt, $page, $perPage);
        return $response;
    }

    /**
     * Operation getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequestsWithHttpInfo
     *
     * commit的相关的pull request列表
     *
     * @param  int $enterpriseId 企业id (required)
     ...
     */
    public function getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequestsWithHttpInfo($enterpriseId, $projectId, $commitId, $accessToken = null, $qt = null, $page = '1', $perPage = null)
    {
        $returnType = '\GiteeEnterprise\Model\PullRequest[]';
        $request = $this->getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequestsRequest($enterpriseId, $projectId, $commitId, $accessToken, $qt, $page, $perPage);
    ...
    /**
     * Operation getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequestsAsync
     *
     * commit的相关的pull request列表
     *
     * @param  int $enterpriseId 企业id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequestsAsync($enterpriseId, $projectId, $commitId, $accessToken = null, $qt = null, $page = '1', $perPage = null)
    {
        return $this->getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequestsAsyncWithHttpInfo($enterpriseId, $projectId, $commitId, $accessToken, $qt, $page, $perPage)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequestsAsyncWithHttpInfo
     *
     * commit的相关的pull request列表
     *
     * @param  int $enterpriseId 企业id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequestsAsyncWithHttpInfo($enterpriseId, $projectId, $commitId, $accessToken = null, $qt = null, $page = '1', $perPage = null)
    {
        $returnType = '\GiteeEnterprise\Model\PullRequest[]';
        $request = $this->getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequestsRequest($enterpriseId, $projectId, $commitId, $accessToken, $qt, $page, $perPage);
    ...
    /**
     * Create request for operation 'getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequests'
     *
     * @param  int $enterpriseId 企业id (required)
     * @param  string $projectId 仓库 id 或 path (required)
     * @param  string $commitId commit sha (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequestsRequest($enterpriseId, $projectId, $commitId, $accessToken = null, $qt = null, $page = '1', $perPage = null)
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $enterpriseId when calling getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequests'
            );
        }
        // verify the required parameter 'projectId' is set
        if ($projectId === null || (is_array($projectId) && count($projectId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $projectId when calling getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequests'
            );
        }
        // verify the required parameter 'commitId' is set
        if ($commitId === null || (is_array($commitId) && count($commitId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $commitId when calling getEnterpriseIdProjectsProjectIdCommitCommitIdPullRequests'
            );
        }

        $resourcePath = '/{enterprise_id}/projects/{project_id}/commit/{commit_id}/pull_requests';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getEnterpriseIdProjectsProjectIdCompareDiffForPath
     *
     ...
     * @return void
     */
    public function getEnterpriseIdProjectsProjectIdCompareDiffForPath($enterpriseId, $projectId, $from, $to, $fileIdentifier, $newPath, $oldPath, $accessToken = null, $qt = null)
    {
        $this->getEnterpriseIdProjectsProjectIdCompareDiffForPathWithHttpInfo($enterpriseId, $projectId, $from, $to, $fileIdentifier, $newPath, $oldPath, $accessToken, $qt);
    }

    /**
     * Operation getEnterpriseIdProjectsProjectIdCompareDiffForPathWithHttpInfo
     *
     * 获取 commit 对比中差异较大的文件内容
     *
     * @param  int $enterpriseId 企业id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEnterpriseIdProjectsProjectIdCompareDiffForPathWithHttpInfo($enterpriseId, $projectId, $from, $to, $fileIdentifier, $newPath, $oldPath, $accessToken = null, $qt = null)
    {
        $returnType = '';
        $request = $this->getEnterpriseIdProjectsProjectIdCompareDiffForPathRequest($enterpriseId, $projectId, $from, $to, $fileIdentifier, $newPath, $oldPath, $accessToken, $qt);
    ...
    /**
     * Operation getEnterpriseIdProjectsProjectIdCompareDiffForPathAsync
     *
     * 获取 commit 对比中差异较大的文件内容
     *
     * @param  int $enterpriseId 企业id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdProjectsProjectIdCompareDiffForPathAsync($enterpriseId, $projectId, $from, $to, $fileIdentifier, $newPath, $oldPath, $accessToken = null, $qt = null)
    {
        return $this->getEnterpriseIdProjectsProjectIdCompareDiffForPathAsyncWithHttpInfo($enterpriseId, $projectId, $from, $to, $fileIdentifier, $newPath, $oldPath, $accessToken, $qt)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEnterpriseIdProjectsProjectIdCompareDiffForPathAsyncWithHttpInfo
     *
     * 获取 commit 对比中差异较大的文件内容
     *
     * @param  int $enterpriseId 企业id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdProjectsProjectIdCompareDiffForPathAsyncWithHttpInfo($enterpriseId, $projectId, $from, $to, $fileIdentifier, $newPath, $oldPath, $accessToken = null, $qt = null)
    {
        $returnType = '';
        $request = $this->getEnterpriseIdProjectsProjectIdCompareDiffForPathRequest($enterpriseId, $projectId, $from, $to, $fileIdentifier, $newPath, $oldPath, $accessToken, $qt);
    ...
    /**
     * Create request for operation 'getEnterpriseIdProjectsProjectIdCompareDiffForPath'
     *
     * @param  int $enterpriseId 企业id (required)
     * @param  string $projectId 仓库 id 或 path (required)
     * @param  string $from 起始 commit (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEnterpriseIdProjectsProjectIdCompareDiffForPathRequest($enterpriseId, $projectId, $from, $to, $fileIdentifier, $newPath, $oldPath, $accessToken = null, $qt = null)
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $enterpriseId when calling getEnterpriseIdProjectsProjectIdCompareDiffForPath'
            );
        }
        // verify the required parameter 'projectId' is set
        if ($projectId === null || (is_array($projectId) && count($projectId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $projectId when calling getEnterpriseIdProjectsProjectIdCompareDiffForPath'
            );
        }
        // verify the required parameter 'from' is set
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling getEnterpriseIdProjectsProjectIdCompareDiffForPath'
            );
        }
        // verify the required parameter 'to' is set
        if ($to === null || (is_array($to) && count($to) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $to when calling getEnterpriseIdProjectsProjectIdCompareDiffForPath'
            );
        }
        // verify the required parameter 'fileIdentifier' is set
        if ($fileIdentifier === null || (is_array($fileIdentifier) && count($fileIdentifier) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fileIdentifier when calling getEnterpriseIdProjectsProjectIdCompareDiffForPath'
            );
        }
        // verify the required parameter 'newPath' is set
        if ($newPath === null || (is_array($newPath) && count($newPath) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $newPath when calling getEnterpriseIdProjectsProjectIdCompareDiffForPath'
            );
        }
        // verify the required parameter 'oldPath' is set
        if ($oldPath === null || (is_array($oldPath) && count($oldPath) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $oldPath when calling getEnterpriseIdProjectsProjectIdCompareDiffForPath'
            );
        }

        $resourcePath = '/{enterprise_id}/projects/{project_id}/compare/diff_for_path';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
