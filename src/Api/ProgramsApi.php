...
class ProgramsApi
{
     ...
     * @return \GiteeEnterprise\Model\Issue[]
     */
    public function getEnterpriseIdProgramsProgramIdPullRequests($programId, $enterpriseId, $accessToken = null, $state = null, $scope = null, $authorId = null, $assigneeId = null, $testerId = null, $search = null, $sort = null, $direction = null, $groupId = null, $milestoneId = null, $labels = null, $labelIds = null, $canBeMerged = null, $category = null, $createdAt = null, $updatedAt = null, $mergedAt = null, $targetBranch = null, $sourceBranch = null, $projectId = null, $needStateCount = null, $page = '1', $perPage = null)
    {
        list($response) = $this->getEnterpriseIdProgramsProgramIdPullRequestsWithHttpInfo($programId, $enterpriseId, $accessToken, $state, $scope, $authorId, $assigneeId, $testerId, $search, $sort, $direction, $groupId, $milestoneId, $labels, $labelIds, $canBeMerged, $category, $createdAt, $updatedAt, $mergedAt, $targetBranch, $sourceBranch, $projectId, $needStateCount, $page, $perPage);
        return $response;
    }
     ...
     * @return array of \GiteeEnterprise\Model\Issue[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getEnterpriseIdProgramsProgramIdPullRequestsWithHttpInfo($programId, $enterpriseId, $accessToken = null, $state = null, $scope = null, $authorId = null, $assigneeId = null, $testerId = null, $search = null, $sort = null, $direction = null, $groupId = null, $milestoneId = null, $labels = null, $labelIds = null, $canBeMerged = null, $category = null, $createdAt = null, $updatedAt = null, $mergedAt = null, $targetBranch = null, $sourceBranch = null, $projectId = null, $needStateCount = null, $page = '1', $perPage = null)
    {
        $returnType = '\GiteeEnterprise\Model\Issue[]';
        $request = $this->getEnterpriseIdProgramsProgramIdPullRequestsRequest($programId, $enterpriseId, $accessToken, $state, $scope, $authorId, $assigneeId, $testerId, $search, $sort, $direction, $groupId, $milestoneId, $labels, $labelIds, $canBeMerged, $category, $createdAt, $updatedAt, $mergedAt, $targetBranch, $sourceBranch, $projectId, $needStateCount, $page, $perPage);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdProgramsProgramIdPullRequestsAsync($programId, $enterpriseId, $accessToken = null, $state = null, $scope = null, $authorId = null, $assigneeId = null, $testerId = null, $search = null, $sort = null, $direction = null, $groupId = null, $milestoneId = null, $labels = null, $labelIds = null, $canBeMerged = null, $category = null, $createdAt = null, $updatedAt = null, $mergedAt = null, $targetBranch = null, $sourceBranch = null, $projectId = null, $needStateCount = null, $page = '1', $perPage = null)
    {
        return $this->getEnterpriseIdProgramsProgramIdPullRequestsAsyncWithHttpInfo($programId, $enterpriseId, $accessToken, $state, $scope, $authorId, $assigneeId, $testerId, $search, $sort, $direction, $groupId, $milestoneId, $labels, $labelIds, $canBeMerged, $category, $createdAt, $updatedAt, $mergedAt, $targetBranch, $sourceBranch, $projectId, $needStateCount, $page, $perPage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  int[] $componentsUserIds 多选用户ID (optional)
     *
     * @throws \GiteeEnterprise\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GiteeEnterprise\Model\ProgramComponent[]
     */
    public function putEnterpriseIdProgramsProgramIdUpdateComponents($programId, $componentsIdent, $componentsEnabled, $enterpriseId, $accessToken = null, $componentsCondition = null, $componentsRoleIdsRoleId = null, $componentsUserIds = null)
    {
        list($response) = $this->putEnterpriseIdProgramsProgramIdUpdateComponentsWithHttpInfo($programId, $componentsIdent, $componentsEnabled, $enterpriseId, $accessToken, $componentsCondition, $componentsRoleIdsRoleId, $componentsUserIds);
        return $response;
    }
     ...
     * @return array of \GiteeEnterprise\Model\ProgramComponent[], HTTP status code, HTTP response headers (array of strings)
     */
    public function putEnterpriseIdProgramsProgramIdUpdateComponentsWithHttpInfo($programId, $componentsIdent, $componentsEnabled, $enterpriseId, $accessToken = null, $componentsCondition = null, $componentsRoleIdsRoleId = null, $componentsUserIds = null)
    {
        $returnType = '\GiteeEnterprise\Model\ProgramComponent[]';
        $request = $this->putEnterpriseIdProgramsProgramIdUpdateComponentsRequest($programId, $componentsIdent, $componentsEnabled, $enterpriseId, $accessToken, $componentsCondition, $componentsRoleIdsRoleId, $componentsUserIds);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putEnterpriseIdProgramsProgramIdUpdateComponentsAsync($programId, $componentsIdent, $componentsEnabled, $enterpriseId, $accessToken = null, $componentsCondition = null, $componentsRoleIdsRoleId = null, $componentsUserIds = null)
    {
        return $this->putEnterpriseIdProgramsProgramIdUpdateComponentsAsyncWithHttpInfo($programId, $componentsIdent, $componentsEnabled, $enterpriseId, $accessToken, $componentsCondition, $componentsRoleIdsRoleId, $componentsUserIds)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putEnterpriseIdProgramsProgramIdUpdateComponentsAsyncWithHttpInfo($programId, $componentsIdent, $componentsEnabled, $enterpriseId, $accessToken = null, $componentsCondition = null, $componentsRoleIdsRoleId = null, $componentsUserIds = null)
    {
        $returnType = '\GiteeEnterprise\Model\ProgramComponent[]';
        $request = $this->putEnterpriseIdProgramsProgramIdUpdateComponentsRequest($programId, $componentsIdent, $componentsEnabled, $enterpriseId, $accessToken, $componentsCondition, $componentsRoleIdsRoleId, $componentsUserIds);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putEnterpriseIdProgramsProgramIdUpdateComponentsRequest($programId, $componentsIdent, $componentsEnabled, $enterpriseId, $accessToken = null, $componentsCondition = null, $componentsRoleIdsRoleId = null, $componentsUserIds = null)
    {
        // verify the required parameter 'programId' is set
        if ($programId === null || (is_array($programId) && count($programId) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // form params
        if ($componentsUserIds !== null) {
            $formParams['components[user_ids]'] = ObjectSerializer::toFormValue($componentsUserIds);
        }
        // body params
        $_tempBody = null;
