...
class WorkloadsApi
{
    ...
    /**
     * Operation getEnterpriseIdWorkloadsV2
     *
     * 查询成员工时明细
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     ...
     * @param  string $userIds 用户ID，以逗号分隔。 例：\&quot;1,2,3\&quot; (optional)
     * @param  string $registeredDates 工时登记日期范围。以逗号分隔。 例：\&quot;2022-01-01,2022-02-01\&quot; (optional)
     * @param  int $prevId 上一页最后一条记录的ID (optional)
     *
     * @throws \GiteeEnterprise\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GiteeEnterprise\Model\UserWorkloadsList
     */
    public function getEnterpriseIdWorkloadsV2($enterpriseId, $accessToken = null, $programIds = null, $userIds = null, $registeredDates = null, $prevId = null)
    {
        list($response) = $this->getEnterpriseIdWorkloadsV2WithHttpInfo($enterpriseId, $accessToken, $programIds, $userIds, $registeredDates, $prevId);
        return $response;
    }

    /**
     * Operation getEnterpriseIdWorkloadsV2WithHttpInfo
     *
     * 查询成员工时明细
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     ...
     * @return array of \GiteeEnterprise\Model\UserWorkloadsList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEnterpriseIdWorkloadsV2WithHttpInfo($enterpriseId, $accessToken = null, $programIds = null, $userIds = null, $registeredDates = null, $prevId = null)
    {
        $returnType = '\GiteeEnterprise\Model\UserWorkloadsList';
        $request = $this->getEnterpriseIdWorkloadsV2Request($enterpriseId, $accessToken, $programIds, $userIds, $registeredDates, $prevId);
    ...
    /**
     * Operation getEnterpriseIdWorkloadsV2Async
     *
     * 查询成员工时明细
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdWorkloadsV2Async($enterpriseId, $accessToken = null, $programIds = null, $userIds = null, $registeredDates = null, $prevId = null)
    {
        return $this->getEnterpriseIdWorkloadsV2AsyncWithHttpInfo($enterpriseId, $accessToken, $programIds, $userIds, $registeredDates, $prevId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEnterpriseIdWorkloadsV2AsyncWithHttpInfo
     *
     * 查询成员工时明细
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdWorkloadsV2AsyncWithHttpInfo($enterpriseId, $accessToken = null, $programIds = null, $userIds = null, $registeredDates = null, $prevId = null)
    {
        $returnType = '\GiteeEnterprise\Model\UserWorkloadsList';
        $request = $this->getEnterpriseIdWorkloadsV2Request($enterpriseId, $accessToken, $programIds, $userIds, $registeredDates, $prevId);
    ...
    /**
     * Create request for operation 'getEnterpriseIdWorkloadsV2'
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     * @param  string $accessToken 用户授权码 (optional)
     * @param  string $programIds 项目ID， 以逗号分隔。 例：\&quot;1,2,3\&quot; (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEnterpriseIdWorkloadsV2Request($enterpriseId, $accessToken = null, $programIds = null, $userIds = null, $registeredDates = null, $prevId = null)
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $enterpriseId when calling getEnterpriseIdWorkloadsV2'
            );
        }

        $resourcePath = '/{enterprise_id}/workloads/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
