...
class GroupsApi
{
     ...
     */
    public function getEnterpriseIdGroupsGroupIdMembers($enterpriseId, $groupId, $accessToken = null, $qt = null, $search = null, $sort = null, $direction = null, $page = '1', $perPage = null)
    {
        list($response) = $this->getEnterpriseIdGroupsGroupIdMembersWithHttpInfo($enterpriseId, $groupId, $accessToken, $qt, $search, $sort, $direction, $page, $perPage);
        return $response;
    }
     ...
     */
    public function getEnterpriseIdGroupsGroupIdMembersWithHttpInfo($enterpriseId, $groupId, $accessToken = null, $qt = null, $search = null, $sort = null, $direction = null, $page = '1', $perPage = null)
    {
        $returnType = '\GiteeEnterprise\Model\Member[]';
        $request = $this->getEnterpriseIdGroupsGroupIdMembersRequest($enterpriseId, $groupId, $accessToken, $qt, $search, $sort, $direction, $page, $perPage);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdGroupsGroupIdMembersAsync($enterpriseId, $groupId, $accessToken = null, $qt = null, $search = null, $sort = null, $direction = null, $page = '1', $perPage = null)
    {
        return $this->getEnterpriseIdGroupsGroupIdMembersAsyncWithHttpInfo($enterpriseId, $groupId, $accessToken, $qt, $search, $sort, $direction, $page, $perPage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdGroupsGroupIdMembersAsyncWithHttpInfo($enterpriseId, $groupId, $accessToken = null, $qt = null, $search = null, $sort = null, $direction = null, $page = '1', $perPage = null)
    {
        $returnType = '\GiteeEnterprise\Model\Member[]';
        $request = $this->getEnterpriseIdGroupsGroupIdMembersRequest($enterpriseId, $groupId, $accessToken, $qt, $search, $sort, $direction, $page, $perPage);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEnterpriseIdGroupsGroupIdMembersRequest($enterpriseId, $groupId, $accessToken = null, $qt = null, $search = null, $sort = null, $direction = null, $page = '1', $perPage = null)
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
