...
class DocsApi
{
    ...
    {
        list($response) = $this->getEnterpriseIdDocsDocIdCommitWithHttpInfo($docId, $commitId, $enterpriseId, $accessToken);
        return $response;
    }
     ...
     * @throws \GiteeEnterprise\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GiteeEnterprise\Model\Commit[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getEnterpriseIdDocsDocIdCommitWithHttpInfo($docId, $commitId, $enterpriseId, $accessToken = null)
    {
        $returnType = '\GiteeEnterprise\Model\Commit[]';
