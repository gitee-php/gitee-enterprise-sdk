...
class DocNodesApi
{
     ...
     */
    public function getEnterpriseIdDocNodesLevel($enterpriseId, $parentId, $accessToken = null, $programId = '0', $scope = null, $fileType = null)
    {
        list($response) = $this->getEnterpriseIdDocNodesLevelWithHttpInfo($enterpriseId, $parentId, $accessToken, $programId, $scope, $fileType);
        return $response;
    }
     ...
     */
    public function getEnterpriseIdDocNodesLevelWithHttpInfo($enterpriseId, $parentId, $accessToken = null, $programId = '0', $scope = null, $fileType = null)
    {
        $returnType = '\GiteeEnterprise\Model\DocNodeLevel[]';
        $request = $this->getEnterpriseIdDocNodesLevelRequest($enterpriseId, $parentId, $accessToken, $programId, $scope, $fileType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdDocNodesLevelAsync($enterpriseId, $parentId, $accessToken = null, $programId = '0', $scope = null, $fileType = null)
    {
        return $this->getEnterpriseIdDocNodesLevelAsyncWithHttpInfo($enterpriseId, $parentId, $accessToken, $programId, $scope, $fileType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdDocNodesLevelAsyncWithHttpInfo($enterpriseId, $parentId, $accessToken = null, $programId = '0', $scope = null, $fileType = null)
    {
        $returnType = '\GiteeEnterprise\Model\DocNodeLevel[]';
        $request = $this->getEnterpriseIdDocNodesLevelRequest($enterpriseId, $parentId, $accessToken, $programId, $scope, $fileType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEnterpriseIdDocNodesLevelRequest($enterpriseId, $parentId, $accessToken = null, $programId = '0', $scope = null, $fileType = null)
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
