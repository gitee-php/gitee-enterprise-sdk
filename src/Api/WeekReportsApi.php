...
class WeekReportsApi
{
     ...
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     * @param  string $accessToken 用户授权码 (optional)
     * @param  int $year 年份 (optional, default to 2024)
     ...
     */
    public function getEnterpriseIdWeekReportsMemberReports($enterpriseId, $accessToken = null, $year = '2024', $weekIndex = null, $programId = null, $groupId = null, $memberIds = null, $date = null, $page = '1', $perPage = null)
    {
     ...
     */
    public function getEnterpriseIdWeekReportsMemberReportsWithHttpInfo($enterpriseId, $accessToken = null, $year = '2024', $weekIndex = null, $programId = null, $groupId = null, $memberIds = null, $date = null, $page = '1', $perPage = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdWeekReportsMemberReportsAsync($enterpriseId, $accessToken = null, $year = '2024', $weekIndex = null, $programId = null, $groupId = null, $memberIds = null, $date = null, $page = '1', $perPage = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdWeekReportsMemberReportsAsyncWithHttpInfo($enterpriseId, $accessToken = null, $year = '2024', $weekIndex = null, $programId = null, $groupId = null, $memberIds = null, $date = null, $page = '1', $perPage = null)
    {
        $returnType = '\GiteeEnterprise\Model\MemberWeekReport';
        $request = $this->getEnterpriseIdWeekReportsMemberReportsRequest($enterpriseId, $accessToken, $year, $weekIndex, $programId, $groupId, $memberIds, $date, $page, $perPage);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEnterpriseIdWeekReportsMemberReportsRequest($enterpriseId, $accessToken = null, $year = '2024', $weekIndex = null, $programId = null, $groupId = null, $memberIds = null, $date = null, $page = '1', $perPage = null)
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getEnterpriseIdWeekReportsMyReports($enterpriseId, $accessToken = null, $year = '2024')
    {
     ...
     */
    public function getEnterpriseIdWeekReportsMyReportsWithHttpInfo($enterpriseId, $accessToken = null, $year = '2024')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdWeekReportsMyReportsAsync($enterpriseId, $accessToken = null, $year = '2024')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdWeekReportsMyReportsAsyncWithHttpInfo($enterpriseId, $accessToken = null, $year = '2024')
    {
        $returnType = '\GiteeEnterprise\Model\MyWeekReport';
        $request = $this->getEnterpriseIdWeekReportsMyReportsRequest($enterpriseId, $accessToken, $year);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEnterpriseIdWeekReportsMyReportsRequest($enterpriseId, $accessToken = null, $year = '2024')
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
