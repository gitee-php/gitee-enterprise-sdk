...
class IssuesApi
{
    ...
    /**
     * Operation getEnterpriseIdIssuesAttachFileIssues
     *
     * 显示全部有附件的issue
     *
     ...
     * @param  int $page 当前的页码 (optional, default to 1)
     * @param  int $perPage 每页的数量，最大为 100 (optional)
     * @param  int $programId 所在项目 (optional)
     * @param  string $search #号开头搜索ident,否则搜索title (optional)
     *
     * @throws \GiteeEnterprise\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GiteeEnterprise\Model\WithAttachFiles[]
     */
    public function getEnterpriseIdIssuesAttachFileIssues($enterpriseId, $accessToken = null, $page = '1', $perPage = null, $programId = null, $search = null)
    {
        list($response) = $this->getEnterpriseIdIssuesAttachFileIssuesWithHttpInfo($enterpriseId, $accessToken, $page, $perPage, $programId, $search);
        return $response;
    }

    /**
     * Operation getEnterpriseIdIssuesAttachFileIssuesWithHttpInfo
     *
     * 显示全部有附件的issue
     *
     ...
     * @throws \GiteeEnterprise\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GiteeEnterprise\Model\WithAttachFiles[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getEnterpriseIdIssuesAttachFileIssuesWithHttpInfo($enterpriseId, $accessToken = null, $page = '1', $perPage = null, $programId = null, $search = null)
    {
        $returnType = '\GiteeEnterprise\Model\WithAttachFiles[]';
        $request = $this->getEnterpriseIdIssuesAttachFileIssuesRequest($enterpriseId, $accessToken, $page, $perPage, $programId, $search);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\GiteeEnterprise\Model\WithAttachFiles[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getEnterpriseIdIssuesAttachFileIssuesAsync
     *
     * 显示全部有附件的issue
     *
     * @param  int $enterpriseId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdIssuesAttachFileIssuesAsync($enterpriseId, $accessToken = null, $page = '1', $perPage = null, $programId = null, $search = null)
    {
        return $this->getEnterpriseIdIssuesAttachFileIssuesAsyncWithHttpInfo($enterpriseId, $accessToken, $page, $perPage, $programId, $search)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEnterpriseIdIssuesAttachFileIssuesAsyncWithHttpInfo
     *
     * 显示全部有附件的issue
     *
     * @param  int $enterpriseId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdIssuesAttachFileIssuesAsyncWithHttpInfo($enterpriseId, $accessToken = null, $page = '1', $perPage = null, $programId = null, $search = null)
    {
        $returnType = '\GiteeEnterprise\Model\WithAttachFiles[]';
        $request = $this->getEnterpriseIdIssuesAttachFileIssuesRequest($enterpriseId, $accessToken, $page, $perPage, $programId, $search);
    ...
    /**
     * Create request for operation 'getEnterpriseIdIssuesAttachFileIssues'
     *
     * @param  int $enterpriseId (required)
     * @param  string $accessToken 用户授权码 (optional)
     * @param  int $page 当前的页码 (optional, default to 1)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEnterpriseIdIssuesAttachFileIssuesRequest($enterpriseId, $accessToken = null, $page = '1', $perPage = null, $programId = null, $search = null)
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $enterpriseId when calling getEnterpriseIdIssuesAttachFileIssues'
            );
        }

        $resourcePath = '/{enterprise_id}/issues/attach_file_issues';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheck
     *
     * 查询当前工作项的排期是否可以更新
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     * @param  int $issueId 工作项 id (required)
     * @param  string $planStartedAt 计划开始日期。格式：yyyy-mm-ddTHH:MM:SS (required)
     * @param  string $deadline 计划完成日期。格式：yyyy-mm-ddTHH:MM:SS (required)
     * @param  string $accessToken 用户授权码 (optional)
     *
     * @throws \GiteeEnterprise\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheck($enterpriseId, $issueId, $planStartedAt, $deadline, $accessToken = null)
    {
        $this->getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheckWithHttpInfo($enterpriseId, $issueId, $planStartedAt, $deadline, $accessToken);
    }

    /**
     * Operation getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheckWithHttpInfo
     *
     * 查询当前工作项的排期是否可以更新
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheckWithHttpInfo($enterpriseId, $issueId, $planStartedAt, $deadline, $accessToken = null)
    {
        $returnType = '';
        $request = $this->getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheckRequest($enterpriseId, $issueId, $planStartedAt, $deadline, $accessToken);
    ...
    /**
     * Operation getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheckAsync
     *
     * 查询当前工作项的排期是否可以更新
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheckAsync($enterpriseId, $issueId, $planStartedAt, $deadline, $accessToken = null)
    {
        return $this->getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheckAsyncWithHttpInfo($enterpriseId, $issueId, $planStartedAt, $deadline, $accessToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheckAsyncWithHttpInfo
     *
     * 查询当前工作项的排期是否可以更新
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheckAsyncWithHttpInfo($enterpriseId, $issueId, $planStartedAt, $deadline, $accessToken = null)
    {
        $returnType = '';
        $request = $this->getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheckRequest($enterpriseId, $issueId, $planStartedAt, $deadline, $accessToken);
    ...
    /**
     * Create request for operation 'getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheck'
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     * @param  int $issueId 工作项 id (required)
     * @param  string $planStartedAt 计划开始日期。格式：yyyy-mm-ddTHH:MM:SS (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheckRequest($enterpriseId, $issueId, $planStartedAt, $deadline, $accessToken = null)
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $enterpriseId when calling getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheck'
            );
        }
        // verify the required parameter 'issueId' is set
        if ($issueId === null || (is_array($issueId) && count($issueId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $issueId when calling getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheck'
            );
        }
        // verify the required parameter 'planStartedAt' is set
        if ($planStartedAt === null || (is_array($planStartedAt) && count($planStartedAt) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $planStartedAt when calling getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheck'
            );
        }
        // verify the required parameter 'deadline' is set
        if ($deadline === null || (is_array($deadline) && count($deadline) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $deadline when calling getEnterpriseIdIssuesIssueIdIssueScheduleUpdateCheck'
            );
        }

        $resourcePath = '/{enterprise_id}/issues/{issue_id}/issue_schedule_update_check';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getEnterpriseIdIssuesIssueIdProgramGanttIssues
     *
     * 查询指定工作项所在项目的工作项列表
     *
     * @param  int $enterpriseId 企业 id (required)
     * @param  int $issueId 工作项 id (required)
     * @param  string $programId 项目ID (required)
     * @param  string $accessToken 用户授权码 (optional)
     * @param  string $milestoneId 里程碑 id（可多选，用英文逗号分隔） (optional)
     * @param  string $state 任务状态属性，可多选，用逗号分隔。（开启：open 关闭：closed 拒绝：rejected 进行中: progressing） (optional)
     * @param  string $onlyRelatedMe 是否仅列出与授权用户相关的任务（0: 否 1: 是） (optional)
     ...
     * @param  string $kanbanIds 看板id(可多选，用英文逗号分隔) (optional)
     * @param  string $kanbanColumnIds 看板栏id(可多选，用英文逗号分隔) (optional)
     * @param  int $rootId 根结点ID (optional)
     * @param  int $parentId 父任务ID (optional)
     * @param  int $page 当前的页码 (optional, default to 1)
     * @param  int $perPage 每页的数量，最大为 100 (optional)
     *
     * @throws \GiteeEnterprise\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GiteeEnterprise\Model\IssueGantt[]
     */
    public function getEnterpriseIdIssuesIssueIdProgramGanttIssues($enterpriseId, $issueId, $programId, $accessToken = null, $milestoneId = null, $state = null, $onlyRelatedMe = null, $assigneeId = null, $authorId = null, $collaboratorIds = null, $createdAt = null, $finishedAt = null, $planStartedAt = null, $deadline = null, $search = null, $filterChild = null, $issueStateIds = null, $issueTypeId = null, $labelIds = null, $priority = null, $scrumSprintIds = null, $scrumVersionIds = null, $kanbanIds = null, $kanbanColumnIds = null, $rootId = null, $parentId = null, $page = '1', $perPage = null)
    {
        list($response) = $this->getEnterpriseIdIssuesIssueIdProgramGanttIssuesWithHttpInfo($enterpriseId, $issueId, $programId, $accessToken, $milestoneId, $state, $onlyRelatedMe, $assigneeId, $authorId, $collaboratorIds, $createdAt, $finishedAt, $planStartedAt, $deadline, $search, $filterChild, $issueStateIds, $issueTypeId, $labelIds, $priority, $scrumSprintIds, $scrumVersionIds, $kanbanIds, $kanbanColumnIds, $rootId, $parentId, $page, $perPage);
        return $response;
    }

    /**
     * Operation getEnterpriseIdIssuesIssueIdProgramGanttIssuesWithHttpInfo
     *
     * 查询指定工作项所在项目的工作项列表
     *
     * @param  int $enterpriseId 企业 id (required)
     ...
     * @throws \GiteeEnterprise\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GiteeEnterprise\Model\IssueGantt[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getEnterpriseIdIssuesIssueIdProgramGanttIssuesWithHttpInfo($enterpriseId, $issueId, $programId, $accessToken = null, $milestoneId = null, $state = null, $onlyRelatedMe = null, $assigneeId = null, $authorId = null, $collaboratorIds = null, $createdAt = null, $finishedAt = null, $planStartedAt = null, $deadline = null, $search = null, $filterChild = null, $issueStateIds = null, $issueTypeId = null, $labelIds = null, $priority = null, $scrumSprintIds = null, $scrumVersionIds = null, $kanbanIds = null, $kanbanColumnIds = null, $rootId = null, $parentId = null, $page = '1', $perPage = null)
    {
        $returnType = '\GiteeEnterprise\Model\IssueGantt[]';
        $request = $this->getEnterpriseIdIssuesIssueIdProgramGanttIssuesRequest($enterpriseId, $issueId, $programId, $accessToken, $milestoneId, $state, $onlyRelatedMe, $assigneeId, $authorId, $collaboratorIds, $createdAt, $finishedAt, $planStartedAt, $deadline, $search, $filterChild, $issueStateIds, $issueTypeId, $labelIds, $priority, $scrumSprintIds, $scrumVersionIds, $kanbanIds, $kanbanColumnIds, $rootId, $parentId, $page, $perPage);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\GiteeEnterprise\Model\IssueGantt[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getEnterpriseIdIssuesIssueIdProgramGanttIssuesAsync
     *
     * 查询指定工作项所在项目的工作项列表
     *
     * @param  int $enterpriseId 企业 id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdIssuesIssueIdProgramGanttIssuesAsync($enterpriseId, $issueId, $programId, $accessToken = null, $milestoneId = null, $state = null, $onlyRelatedMe = null, $assigneeId = null, $authorId = null, $collaboratorIds = null, $createdAt = null, $finishedAt = null, $planStartedAt = null, $deadline = null, $search = null, $filterChild = null, $issueStateIds = null, $issueTypeId = null, $labelIds = null, $priority = null, $scrumSprintIds = null, $scrumVersionIds = null, $kanbanIds = null, $kanbanColumnIds = null, $rootId = null, $parentId = null, $page = '1', $perPage = null)
    {
        return $this->getEnterpriseIdIssuesIssueIdProgramGanttIssuesAsyncWithHttpInfo($enterpriseId, $issueId, $programId, $accessToken, $milestoneId, $state, $onlyRelatedMe, $assigneeId, $authorId, $collaboratorIds, $createdAt, $finishedAt, $planStartedAt, $deadline, $search, $filterChild, $issueStateIds, $issueTypeId, $labelIds, $priority, $scrumSprintIds, $scrumVersionIds, $kanbanIds, $kanbanColumnIds, $rootId, $parentId, $page, $perPage)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEnterpriseIdIssuesIssueIdProgramGanttIssuesAsyncWithHttpInfo
     *
     * 查询指定工作项所在项目的工作项列表
     *
     * @param  int $enterpriseId 企业 id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnterpriseIdIssuesIssueIdProgramGanttIssuesAsyncWithHttpInfo($enterpriseId, $issueId, $programId, $accessToken = null, $milestoneId = null, $state = null, $onlyRelatedMe = null, $assigneeId = null, $authorId = null, $collaboratorIds = null, $createdAt = null, $finishedAt = null, $planStartedAt = null, $deadline = null, $search = null, $filterChild = null, $issueStateIds = null, $issueTypeId = null, $labelIds = null, $priority = null, $scrumSprintIds = null, $scrumVersionIds = null, $kanbanIds = null, $kanbanColumnIds = null, $rootId = null, $parentId = null, $page = '1', $perPage = null)
    {
        $returnType = '\GiteeEnterprise\Model\IssueGantt[]';
        $request = $this->getEnterpriseIdIssuesIssueIdProgramGanttIssuesRequest($enterpriseId, $issueId, $programId, $accessToken, $milestoneId, $state, $onlyRelatedMe, $assigneeId, $authorId, $collaboratorIds, $createdAt, $finishedAt, $planStartedAt, $deadline, $search, $filterChild, $issueStateIds, $issueTypeId, $labelIds, $priority, $scrumSprintIds, $scrumVersionIds, $kanbanIds, $kanbanColumnIds, $rootId, $parentId, $page, $perPage);
    ...
    /**
     * Create request for operation 'getEnterpriseIdIssuesIssueIdProgramGanttIssues'
     *
     * @param  int $enterpriseId 企业 id (required)
     * @param  int $issueId 工作项 id (required)
     * @param  string $programId 项目ID (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEnterpriseIdIssuesIssueIdProgramGanttIssuesRequest($enterpriseId, $issueId, $programId, $accessToken = null, $milestoneId = null, $state = null, $onlyRelatedMe = null, $assigneeId = null, $authorId = null, $collaboratorIds = null, $createdAt = null, $finishedAt = null, $planStartedAt = null, $deadline = null, $search = null, $filterChild = null, $issueStateIds = null, $issueTypeId = null, $labelIds = null, $priority = null, $scrumSprintIds = null, $scrumVersionIds = null, $kanbanIds = null, $kanbanColumnIds = null, $rootId = null, $parentId = null, $page = '1', $perPage = null)
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $enterpriseId when calling getEnterpriseIdIssuesIssueIdProgramGanttIssues'
            );
        }
        // verify the required parameter 'issueId' is set
        if ($issueId === null || (is_array($issueId) && count($issueId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $issueId when calling getEnterpriseIdIssuesIssueIdProgramGanttIssues'
            );
        }
        // verify the required parameter 'programId' is set
        if ($programId === null || (is_array($programId) && count($programId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $programId when calling getEnterpriseIdIssuesIssueIdProgramGanttIssues'
            );
        }

        $resourcePath = '/{enterprise_id}/issues/{issue_id}/program_gantt_issues';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($rootId !== null) {
            $queryParams['root_id'] = ObjectSerializer::toQueryValue($rootId);
        }
        // query params
        if ($parentId !== null) {
    ...
    protected function postEnterpriseIdIssuesRequest($enterpriseId, $title, $accessToken = null, $copiedIssueId = null, $description = null, $assigneeId = null, $collaboratorIds = null, $issueTypeId = null, $programId = null, $projectId = null, $milestoneId = null, $labelIds = null, $priority = null, $parentId = null, $branch = null, $planStartedAt = null, $deadline = null, $startedAt = null, $finishedAt = null, $attachmentIds = null, $securityHole = null, $extraFieldsIssueFieldId = null, $extraFieldsValue = null, $kanbanId = null, $kanbanColumnId = null, $scrumSprintId = null, $scrumVersionId = null, $estimatedDuration = null, $duration = null, $testPlanCaseId = null, $pullRequestId = null, $category = null, $linkIssueId = null, $linkRefType = null, $linkDirection = null, $linkResultType = null, $linkDocNodeId = null)
    {
        ...
        // form params
        if ($linkDocNodeId !== null) {
            $formParams['link_doc_node_id'] = ObjectSerializer::toFormValue($linkDocNodeId);
        }
        // body params
        $_tempBody = null;
    ...
    /**
     * Operation postEnterpriseIdIssuesIssueIdMultiLinkIssues
     *
     * 给指定工作项批量更新关联工作项
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     * @param  int $issueId 工作项 id (required)
     * @param  int[] $linkIssueIds 关联工作项的ID列表,例如[1,2,3] (required)
     * @param  string $refType 关联关系(normal, finish_to_finish, finish_to_start, start_to_start, start_to_finish) (required)
     * @param  string $direction 关联关系的方向(none, pre, latter) (required)
     * @param  string $accessToken 用户授权码 (optional)
     *
     * @throws \GiteeEnterprise\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postEnterpriseIdIssuesIssueIdMultiLinkIssues($enterpriseId, $issueId, $linkIssueIds, $refType, $direction, $accessToken = null)
    {
        $this->postEnterpriseIdIssuesIssueIdMultiLinkIssuesWithHttpInfo($enterpriseId, $issueId, $linkIssueIds, $refType, $direction, $accessToken);
    }

    /**
     * Operation postEnterpriseIdIssuesIssueIdMultiLinkIssuesWithHttpInfo
     *
     * 给指定工作项批量更新关联工作项
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postEnterpriseIdIssuesIssueIdMultiLinkIssuesWithHttpInfo($enterpriseId, $issueId, $linkIssueIds, $refType, $direction, $accessToken = null)
    {
        $returnType = '';
        $request = $this->postEnterpriseIdIssuesIssueIdMultiLinkIssuesRequest($enterpriseId, $issueId, $linkIssueIds, $refType, $direction, $accessToken);
    ...
    /**
     * Operation postEnterpriseIdIssuesIssueIdMultiLinkIssuesAsync
     *
     * 给指定工作项批量更新关联工作项
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postEnterpriseIdIssuesIssueIdMultiLinkIssuesAsync($enterpriseId, $issueId, $linkIssueIds, $refType, $direction, $accessToken = null)
    {
        return $this->postEnterpriseIdIssuesIssueIdMultiLinkIssuesAsyncWithHttpInfo($enterpriseId, $issueId, $linkIssueIds, $refType, $direction, $accessToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postEnterpriseIdIssuesIssueIdMultiLinkIssuesAsyncWithHttpInfo
     *
     * 给指定工作项批量更新关联工作项
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postEnterpriseIdIssuesIssueIdMultiLinkIssuesAsyncWithHttpInfo($enterpriseId, $issueId, $linkIssueIds, $refType, $direction, $accessToken = null)
    {
        $returnType = '';
        $request = $this->postEnterpriseIdIssuesIssueIdMultiLinkIssuesRequest($enterpriseId, $issueId, $linkIssueIds, $refType, $direction, $accessToken);
    ...
    /**
     * Create request for operation 'postEnterpriseIdIssuesIssueIdMultiLinkIssues'
     *
     * @param  int $enterpriseId 企业id (https://gitee.com/api/v8/swagger#/getList 的返回值的 id) (required)
     * @param  int $issueId 工作项 id (required)
     * @param  int[] $linkIssueIds 关联工作项的ID列表,例如[1,2,3] (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postEnterpriseIdIssuesIssueIdMultiLinkIssuesRequest($enterpriseId, $issueId, $linkIssueIds, $refType, $direction, $accessToken = null)
    {
        // verify the required parameter 'enterpriseId' is set
        if ($enterpriseId === null || (is_array($enterpriseId) && count($enterpriseId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $enterpriseId when calling postEnterpriseIdIssuesIssueIdMultiLinkIssues'
            );
        }
        // verify the required parameter 'issueId' is set
        if ($issueId === null || (is_array($issueId) && count($issueId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $issueId when calling postEnterpriseIdIssuesIssueIdMultiLinkIssues'
            );
        }
        // verify the required parameter 'linkIssueIds' is set
        if ($linkIssueIds === null || (is_array($linkIssueIds) && count($linkIssueIds) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $linkIssueIds when calling postEnterpriseIdIssuesIssueIdMultiLinkIssues'
            );
        }
        // verify the required parameter 'refType' is set
        if ($refType === null || (is_array($refType) && count($refType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $refType when calling postEnterpriseIdIssuesIssueIdMultiLinkIssues'
            );
        }
        // verify the required parameter 'direction' is set
        if ($direction === null || (is_array($direction) && count($direction) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $direction when calling postEnterpriseIdIssuesIssueIdMultiLinkIssues'
            );
        }

        $resourcePath = '/{enterprise_id}/issues/{issue_id}/multi_link_issues';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // form params
        if ($linkIssueIds !== null) {
            $formParams['link_issue_ids'] = ObjectSerializer::toFormValue($linkIssueIds);
        }
        // form params
        if ($refType !== null) {
     ...
     * @param  string $dependencyType 后继任务的时间更新方式，更新所有是all,更新下一个是single (optional)
     * @param  string $startedAt 实际开始时间。格式：yyyy-mm-ddTHH:MM:SS (optional)
     * @param  string $finishedAt 实际完成时间。格式：yyyy-mm-ddTHH:MM:SS (optional)
     * @param  int $securityHole 是否是私有issue, 0:否，1:是 (optional)
     * @param  int $scrumSprintId 迭代ID (optional)
     ...
     * @param  float $estimatedDuration 预估工时(单位：小时， 支持两位小数) (optional)
     * @param  int $duration 预估工时。（单位：分钟） (optional)
     * @param  string[] $changeStates 变更的状态 {source_id1: target_id1, source_id2: target_id2} (optional)
     ...
     * @return \GiteeEnterprise\Model\IssueDetail
     */
    public function putEnterpriseIdIssuesIssueId($enterpriseId, $issueId, $accessToken = null, $title = null, $description = null, $assigneeId = null, $collaboratorIds = null, $issueTypeId = null, $issueStateId = null, $programId = null, $projectId = null, $milestoneId = null, $labelIds = null, $priority = null, $parentId = null, $branch = null, $planStartedAt = null, $deadline = null, $dependencyType = null, $startedAt = null, $finishedAt = null, $securityHole = null, $scrumSprintId = null, $scrumVersionId = null, $kanbanId = null, $kanbanColumnId = null, $estimatedDuration = null, $duration = null, $changeStates = null, $hierarchyChangeMethod = null)
    {
    ...
    protected function putEnterpriseIdIssuesIssueIdRequest($enterpriseId, $issueId, $accessToken = null, $title = null, $description = null, $assigneeId = null, $collaboratorIds = null, $issueTypeId = null, $issueStateId = null, $programId = null, $projectId = null, $milestoneId = null, $labelIds = null, $priority = null, $parentId = null, $branch = null, $planStartedAt = null, $deadline = null, $dependencyType = null, $startedAt = null, $finishedAt = null, $securityHole = null, $scrumSprintId = null, $scrumVersionId = null, $kanbanId = null, $kanbanColumnId = null, $estimatedDuration = null, $duration = null, $changeStates = null, $hierarchyChangeMethod = null)
    {
        ...
        if ($dependencyType !== null) {
            $formParams['dependency_type'] = ObjectSerializer::toFormValue($dependencyType);
        }
        // form params
        if ($startedAt !== null) {
            $formParams['started_at'] = ObjectSerializer::toFormValue($startedAt);
